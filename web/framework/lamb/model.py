...
class model(object):
    ...
    # todo: some kind of prefix on these so that we can actually use the variable names
    ...
    def batch_save(self, items):
        ...
        return self.db.batch_save(obj, items)
    ...
    # get multiple from db by list of ids
    @classmethod
    def batch_get(self, ids):
        obj = self.get_model_obj()
        return self.db.batch_get(obj, ids)
